...
//https://stackoverflow.com/questions/24848978/unable-to-reference-microsoft-xna-framework-media-phoneextensions-dll/
...
namespace ShooterLab1.MacOS
{
    ...
    public class Game1 :  Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(font, "health: " + player.Health, new Vector2(GraphicsDevice.Viewport.TitleSafeArea.X, GraphicsDevice.Viewport.TitleSafeArea.Y + 24), Color.White);
        ...
        private void UpdateCollision()
        {
            ...
            for (int i = 0; i < enemies.Count; i++)
            {
                ...
                if (rectangle1.Intersects(rectangle2))
                {
                    ...
                    //System.Diagnostics.Debug.Print(player.Health.ToString());
